...
The native OpenCode integration is a prerelease in `v1.3.15-pre.1`, tested with OpenCode 1.18.3. It reads the same `~/.lore/config.json` shown above and installs one managed file:
...
curl -fL https://github.com/FFatTiger/lore/releases/download/v1.3.15-pre.1/lore-opencode.zip \
