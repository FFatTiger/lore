...
export default function MemoryBrowser(): React.JSX.Element {
  ...
  return (
    <div className="h-full w-full overflow-hidden" data-memory-browser-shell="true">
      <div className="flex h-full min-h-0">
        ...
        <main className="min-w-0 flex-1 overflow-y-auto" data-memory-content="true">
          <div className="mx-auto w-full max-w-[980px] px-5 py-8 md:px-8 md:py-12">
          {loading ? (
